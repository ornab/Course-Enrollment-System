...
for($i=1;$i<=$noOfPage;$i++)
{
    ...
    $pagination.="<li class='$active' }><a href='accounts.php?pageNumber=$i'>$i</a></li>";
}
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="ibox float-e-margins">
                        ...
                        <form role="form" action="accounts.php">
                            <div class="form-group">
            ...
            <?php if((strtoupper($_SERVER['REQUEST_METHOD']=='GET'))) { ?>
                <ul class="pagination">
                    <li class="<?php if($pageNo==1) {echo "hidden";}?>"><a href="accounts.php?pageNumber=<?php echo $pageNo-1;?>">Prev</a></li>
                    <?php echo $pagination;?>
                    <li class="<?php if($noOfPage==$pageNo){echo "hidden";}?>"><a href="accounts.php?pageNumber=<?php echo $pageNo+1;?>">Next</a></li>
                </ul>
            <?php }?>
